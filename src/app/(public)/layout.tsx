...
import { PublicNavigationFeedbackProvider } from "@/components/navigation/public-navigation-feedback";
...
export default async function PublicLayout({ children }: Readonly<{ children: ReactNode }>) {
  ...
  return (
    <PublicNavigationFeedbackProvider><PublicIdentityProvider identidad={identidad}><div className="flex min-h-full w-full min-w-0 max-w-full flex-1 flex-col overflow-x-hidden">
      ...
      <FloatingCartButton />
    </div></PublicIdentityProvider></PublicNavigationFeedbackProvider>
  );
}
