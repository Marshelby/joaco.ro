-- C1: asegura de forma idempotente la identidad comercial del usuario actual.
-- No vincula clientes legacy por email y no crea clientes para administradores.

create function public.ensure_cuenta_cliente_actual()
returns table (
  usuario_id uuid,
