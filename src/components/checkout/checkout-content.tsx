...
type DireccionCheckout = { id: string; nombre: string | null; destinatario: string | null; direccion: string; comuna: string; region: string; referencia: string | null; zonas_entrega: { nombre: string }[] };
