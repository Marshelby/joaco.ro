...
export function FloatingCartButton() {
  ...
  return (
    <Link
      ...
      className="box-border fixed right-4 bottom-[calc(1rem+env(safe-area-inset-bottom))] z-40 inline-flex w-fit min-h-11 max-w-[calc(100%-2rem)] min-w-0 items-center gap-2 overflow-hidden rounded-full bg-primary px-4 text-sm font-semibold text-primary-foreground shadow-lg outline-none transition-transform hover:bg-primary/90 focus-visible:ring-3 focus-visible:ring-ring/50 active:translate-y-px"
    >
