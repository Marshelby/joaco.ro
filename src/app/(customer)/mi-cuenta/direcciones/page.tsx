...
type DireccionFila = { id: string; nombre: string | null; destinatario: string | null; telefono_contacto: string | null; direccion: string; comuna: string; referencia: string | null; es_principal: boolean; zonas_entrega: { nombre: string }[] };
...
export default async function CustomerAddressesPage() {
  ...
  const { data: direcciones, error } = await supabase
    ...
    .select("id,nombre,destinatario,telefono_contacto,direccion,comuna,referencia,es_principal,zonas_entrega(nombre)")
